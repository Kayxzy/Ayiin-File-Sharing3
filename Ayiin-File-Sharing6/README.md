...
## Installation
### 𝗗𝗲𝗽𝗹𝗼𝘆 𝗼𝗻 𝗛𝗲𝗿𝗼𝗸𝘂
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/AyiinXd/Ayiin-File-Sharing6)
...
#### Deploy in your VPS
````bash
git clone https://github.com/AyiinXd/Ayiin-File-Sharing6
cd Ayiin-File-Sharing6
...
* `START_MESSAGE` Opsional: Pesan /start memulai awalan ke bot, Gunakan <a href='https://github.com/AyiinXd/Ayiin-File-Sharing6/blob/main/README.md#start_message'>format</a> parsemode HTML 
...
* `CUSTOM_CAPTION` letakkan teks teks Kustom Anda jika Anda ingin Mengatur Teks Kustom, Anda dapat menggunakan HTML dan <a href='https://github.com/AyiinXd/Ayiin-File-Sharing6/blob/main/README.md#custom_caption'>fillings</a> untuk pemformatan (hanya untuk dokumen)
