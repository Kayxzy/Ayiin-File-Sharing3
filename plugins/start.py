...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("𝗝𝗢𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟", url=client.invitelink),
                InlineKeyboardButton("𝗝𝗢𝗜𝗡 𝗚𝗥𝗢𝗨𝗣", url=client.invitelink2),
            ],
            [
                InlineKeyboardButton("𝗝𝗢𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟", url=client.invitelink3), 
            ],  
            [
